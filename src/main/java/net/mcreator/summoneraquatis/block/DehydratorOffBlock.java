...
public class DehydratorOffBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:dehydrator_off")
	public static final Block block = null;
	@ObjectHolder("summoner_aquatis:dehydrator_off")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public DehydratorOffBlock(SummonerAquatisModElements instance) {
		super(instance, 19);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("dehydrator_off"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dehydrator_off");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("dehydrator_off");
		}
