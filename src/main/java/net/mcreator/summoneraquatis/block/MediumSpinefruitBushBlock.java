...
public class MediumSpinefruitBushBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:medium_spinefruit_bush")
	public static final Block block = null;

	public MediumSpinefruitBushBlock(SummonerAquatisModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("medium_spinefruit_bush");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(2, 0, 2, 14, 12, 14)
