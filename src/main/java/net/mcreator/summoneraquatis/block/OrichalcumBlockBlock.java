...
public class OrichalcumBlockBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:orichalcum_block")
	public static final Block block = null;

	public OrichalcumBlockBlock(SummonerAquatisModElements instance) {
		super(instance, 3);
	}
