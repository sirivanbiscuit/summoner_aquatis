...
import net.mcreator.summoneraquatis.item.OrichalcumItem;
...
public class OrichalcumOreBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:atlantean_debris")
	public static final Block block = null;

	public OrichalcumOreBlock(SummonerAquatisModElements instance) {
		super(instance, 2);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(7f, 8.705505632961241f).setLightLevel(s -> 0)
					.harvestLevel(3).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("atlantean_debris");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(OrichalcumItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("summoner_aquatis:atlantean_debris_match"),
