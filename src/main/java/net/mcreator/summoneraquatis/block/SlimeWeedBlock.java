...
public class SlimeWeedBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:slime_weed")
	public static final Block block = null;

	public SlimeWeedBlock(SummonerAquatisModElements instance) {
		super(instance, 29);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.LILY_PADS)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("slime_weed");
		}
