...
import net.mcreator.summoneraquatis.procedures.SlimeweedExtraGrownBaselessProcedure;
...
public class SlimeWeedBlockExtraGrownBlock extends SummonerAquatisModElements.ModElement {
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AgarJellyBerriesItem.block, (int) (2)));
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			SlimeweedExtraGrownBaselessProcedure.executeProcedure(Stream
