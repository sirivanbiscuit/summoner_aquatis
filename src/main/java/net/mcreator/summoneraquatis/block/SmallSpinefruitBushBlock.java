...
import net.mcreator.summoneraquatis.procedures.SpinefruitGeneralGrowProcedure;
...
public class SmallSpinefruitBushBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:small_spinefruit_bush")
	public static final Block block = null;

	public SmallSpinefruitBushBlock(SummonerAquatisModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.OCEAN_PLANT).sound(SoundType.LILY_PADS).hardnessAndResistance(1.5f, 10f).setLightLevel(s -> 0)
					.notSolid().tickRandomly().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(WATERLOGGED, false));
			setRegistryName("small_spinefruit_bush");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(4, 0, 4, 12, 8, 12)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SpinefruitCuttingItem.block));
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SpinefruitGeneralGrowProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
