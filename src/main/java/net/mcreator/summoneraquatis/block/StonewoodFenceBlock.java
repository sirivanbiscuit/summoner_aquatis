...
public class StonewoodFenceBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:stonewood_fence")
	public static final Block block = null;

	public StonewoodFenceBlock(SummonerAquatisModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("stonewood_fence");
		}
