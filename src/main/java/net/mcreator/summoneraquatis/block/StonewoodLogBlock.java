...
public class StonewoodLogBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:stonewood_log")
	public static final Block block = null;

	public StonewoodLogBlock(SummonerAquatisModElements instance) {
		super(instance, 54);
	}
