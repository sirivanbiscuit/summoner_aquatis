...
public class StonewoodSlabBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:stonewood_slab")
	public static final Block block = null;

	public StonewoodSlabBlock(SummonerAquatisModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stonewood_slab");
		}
