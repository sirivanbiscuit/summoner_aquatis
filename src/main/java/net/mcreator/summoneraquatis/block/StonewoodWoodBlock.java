...
public class StonewoodWoodBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:stonewood_wood")
	public static final Block block = null;

	public StonewoodWoodBlock(SummonerAquatisModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stonewood_wood");
		}
