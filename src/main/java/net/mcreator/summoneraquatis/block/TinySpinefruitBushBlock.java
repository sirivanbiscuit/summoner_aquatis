...
public class TinySpinefruitBushBlock extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:tiny_spinefruit_bush")
	public static final Block block = null;

	public TinySpinefruitBushBlock(SummonerAquatisModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("tiny_spinefruit_bush");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(6, 0, 6, 10, 4, 10)
