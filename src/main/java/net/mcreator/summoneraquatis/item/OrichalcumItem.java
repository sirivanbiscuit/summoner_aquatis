...
public class OrichalcumItem extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:orichalcum")
	public static final Item block = null;

	public OrichalcumItem(SummonerAquatisModElements instance) {
		super(instance, 1);
	}
