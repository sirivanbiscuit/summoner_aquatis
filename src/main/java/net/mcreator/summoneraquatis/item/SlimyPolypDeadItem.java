...
public class SlimyPolypDeadItem extends SummonerAquatisModElements.ModElement {
	@ObjectHolder("summoner_aquatis:slimy_polyp_dead")
	public static final Item block = null;

	public SlimyPolypDeadItem(SummonerAquatisModElements instance) {
		super(instance, 49);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("slimy_polyp_dead");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Surprisingly still squishy"));
