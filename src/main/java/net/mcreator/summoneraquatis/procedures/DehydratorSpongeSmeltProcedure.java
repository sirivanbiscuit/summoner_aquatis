...
public class DehydratorSpongeSmeltProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		} else if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == DehydratorOnBlock.block) {
			if (new Object() {
				...
				if (new Object() {
				...
				}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "furnaceSpeed") >= 50) {
					if (new Object() {
						public int getAmount(IWorld world, BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == Blocks.AIR.asItem())) {
						{
					...
					if (!world.isRemote()) {
						...
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putDouble("furnaceSpeed", 1);
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
				}
				if (!world.isRemote()) {
					...
					BlockState _bs = world.getBlockState(_bp);
					if (_tileEntity != null)
						_tileEntity.getTileData().putDouble("furnaceSpeed", (new Object() {
							public double getValue(IWorld world, BlockPos pos, String tag) {
								TileEntity tileEntity = world.getTileEntity(pos);
								if (tileEntity != null)
									return tileEntity.getTileData().getDouble(tag);
