...
public class DehydratorTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SummonerAquatisMod.LOGGER.warn("Failed to load dependency world for procedure DehydratorTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SummonerAquatisMod.LOGGER.warn("Failed to load dependency x for procedure DehydratorTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SummonerAquatisMod.LOGGER.warn("Failed to load dependency y for procedure DehydratorTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SummonerAquatisMod.LOGGER.warn("Failed to load dependency z for procedure DehydratorTick!");
			return;
		}
		...
		if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == DehydratorOffBlock.block && new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.JUNGLE_SAPLING.getDefaultState(), 3);
		} else if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == DehydratorOffBlock.block && new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
			...
			if (new Object() {
				...
				if (new Object() {
					...
					if (new Object() {
						...
						}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == Blocks.MAGMA_BLOCK.asItem()) {
							{
								TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
								if (_ent != null) {
